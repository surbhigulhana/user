...
function App() {
    const option = {
        items: 2, // Set items to 2 to display two cards in one slide
        loop: true,
        margin: 10,
        responsive: {
          0: {
...
<body>
  ...
  <div className="owl-carousel-item header-carousel position-relative">
     <div className="owl-carousel-item position-relative">
        ...
        </div>{/* Your carousel content */} </div>
  <div className="owl-carousel-item header-carousel position-relative"> {/* Your carousel content */}
  <div className="owl-carousel-item position-relative">
...
{/* <!-- Facilities Start --> */}
                    ...
                    <div class="row g-0">
                        <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s" style={{ minHeight: '400px' }}>
                            <div class="position-relative h-100">
                                <img class=" w-100 h-100 rounded" src="./img/call-to-action.jpg" style={{ objectFit: 'cover' }}/>
                            </div>
                        </div>
            ...
            <div class="container">
                <div class="bg-light rounded">
                    <div class="row g-0">
                        ...
                        <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s" style={{ maxHeight: '400px' }}>
                            <div class="position-relative h-100">
                                <img class=" w-100 h-100 rounded" src="./img/appointment.jpg" style={{ objectFit: 'cover',marginTop: '50px' }}/>
                            </div>
                        </div>
                    </div>
                </div>
      ...
      <div className="container">
        ...
        <OwlCarousel options={option} autoplay>
